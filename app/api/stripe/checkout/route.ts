...
const PACKS = {
  decouverte: { credits: 20, price: 500, label: 'Pack Découverte — 20 crédits' },   // 5€
  pro:         { credits: 50, price: 1000, label: 'Pack Pro — 50 crédits' },          // 10€
  business:    { credits: 120, price: 2000, label: 'Pack Business — 120 crédits' },   // 20€
}
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          ...
          product_data: {
            name: packData.label,
            description: `${packData.credits} crédits Relance IA pour NovaBiz`,
          },
